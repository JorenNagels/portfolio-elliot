...
export const testimonials: Testimonial[] = [
	...
	},
	{
		...
		paragraphs: [
			...
			[
				{ highlight: 'His energy and willingness to make the show as good as possible are unbeatable' },
	...
	},
	{
		...
		paragraphs: [
			...
			[
				...
				'. He just had a personality made for show business and has been integral in the success of every show that we have worked together.',
			],
		],
